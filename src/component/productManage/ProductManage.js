...
import {
    List, Modal, Pagination, message, Empty, Input, Tooltip, Icon, Cascader, Select, Row, Col, Checkbox, Button, AutoComplete, Alert,
} from 'antd';
...
class ProductManage extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('/productservice/api/product/list/by/merchant/' + merchant_id + '/', {
            method: 'GET',
            headers: {
                    ...
                    renderItem={(item, index) => (
                        <List.Item>
                            <List.Item.Meta
                                ...
                                description={<span><Button onClick={this.showModal.bind(this, item)}>详&nbsp;&nbsp;情</Button>&nbsp;&nbsp;<Button type="primary" ghost onClick={this.showChange.bind(this, item, index)}>修&nbsp;&nbsp;改</Button>&nbsp;&nbsp;<Button type="danger" ghost onClick={this.showDeleteConfirm.bind(this, item, index)}>下架</Button></span>}
                            />
                        </List.Item>
                    )
                    }
