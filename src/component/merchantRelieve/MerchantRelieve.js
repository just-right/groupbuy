...
import './MerchantRelieve.css';
import moment from 'moment';

const confirm = Modal.confirm;
class MerchantRelieve extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [],
    ...
    componentDidMount() {
        ...
        fetch('/userservice/api/merchant/list/banned', {
            method: 'GET',
            headers: {
    ...
    showConfirm(item, index) {
        ...
        confirm({
            ...
            onOk: () => {
                ...
                fetch('/userservice/api/administrator/' + merchant_id + '/merchantrelieve/', {
                    method: 'GET',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
...
export default MerchantRelieve;