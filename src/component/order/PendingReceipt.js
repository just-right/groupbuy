...
class PendingReceipt extends React.Component {
    ...
    sureClick(index) {
        ...
        fetch('/orderservice/api/order/'+id+'/receipt/', {
            method: 'GET',
            headers: {
    ...
    componentWillMount() {
        ...
        if (cookie.load('userId')) {
            ...
            fetch('/orderservice/api/order/pendingreceiptlist/by/userid/' + id, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
    ...
    render() {
        ...
        return (
            <Tabs defaultActiveKey="1" style={{ textAlign: 'center' }}>
                <TabPane tab={<span><Icon type="shopping-cart" />待收货订单列表</span>} key="1">
                    <List
                        size="large"
                        header={
                                ...
                                return <List.Item key={Math.random()}>
                                    <div className="gutter-example">
                                        <Row gutter={20} justify="center">
                                            ...
                                            <Col className="gutter-row" span={6}>
                                                <div className="gutter-box"><span><Icon type="clock-circle" theme="twoTone" />&nbsp;&nbsp;已发货->待收货&nbsp;&nbsp;&nbsp;&nbsp;</span><Button type="primary" onClick={this.sureClick.bind(this, index)}>确认收货</Button></div>
                                            </Col>
