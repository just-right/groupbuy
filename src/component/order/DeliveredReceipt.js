...
class DeliveredReceipt extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            userID: '',
    ...
    componentWillMount() {
        ...
        if (cookie.load('userId')) {
            ...
            fetch('/orderservice/api/order/paylist/by/userid/' + id, {
                method: 'GET',
                headers: {
    ...
    render() {
        ...
        return (
            <Tabs defaultActiveKey="1" style={{ textAlign: 'center' }}>
                <TabPane tab={<span><Icon type="shopping-cart" />待发货订单列表</span>} key="1">
                    <List
                        size="large"
                        header={
                                ...
                                return <List.Item key={Math.random()}>
                                    <div className="gutter-example">
                                        <Row gutter={20} justify="center">
                                            ...
                                            <Col className="gutter-row" span={6}>
                                                <div className="gutter-box"><span><Icon type="clock-circle" theme="twoTone" />&nbsp;&nbsp;已付款->待发货</span></div>
                                            </Col>
...
export default DeliveredReceipt;